	...
	return <ModuleSettings settings={settings} base={ProjectModuleBase.D9} index={index}
		...
		<Component name="@rainbow-o23/n91"
		           description={<>
			           ...
			           data-name={true}>@rainbow-o23/n5</span>, <span data-name={true}>@rainbow-o23/n6</span>, <span
			           data-name={true}>@rainbow-o23/n7</span> have been included in this plugin component.
		           </>}
		...
		<Component name="@rainbow-o23/n90"
		           description={<>
			           ...
			           applications. <span data-name={true}>@rainbow-o23/n1</span>, <span
			           data-name={true}>@rainbow-o23/n2</span>, <span data-name={true}>@rainbow-o23/n3</span>, <span
			           data-name={true}>@rainbow-o23/n4</span> have been included in this component.</>}
		           fixed={true}/>
	</ModuleSettings>;
};
