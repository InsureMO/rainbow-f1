...
export const FolderClosedIcon = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="f1-folder-closed" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
		<path
