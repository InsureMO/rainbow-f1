...
export const ModuleEnvFilesIcon = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="f1-module-env-files" viewBox="0 0 24 24" fill="none"
