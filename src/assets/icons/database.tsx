...
export const DatabaseIcon = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="f1-database" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
