...
export const EslintIcon = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="f1-eslint" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
		<path
