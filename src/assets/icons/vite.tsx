...
export const ViteIcon = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="f1-vite" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none">
		<path
		...
		<path
			...
			fill="url(#f1-vite-style-2)"/>
		<defs id="defs50">
			<linearGradient id="f1-vite-style-1" x1="6.0002" y1="32.9999" x2="235" y2="344"
			                gradientUnits="userSpaceOnUse"
			                gradientTransform="matrix(.07142 0 0 .07142 1.3398 1.8944)">
				<stop stopColor="#41D1FF"/>
				<stop offset="1" stopColor="#BD34FE"/>
			</linearGradient>
			<linearGradient id="f1-vite-style-2" x1="194.651" y1="8.8182" x2="236.076" y2="292.989"
