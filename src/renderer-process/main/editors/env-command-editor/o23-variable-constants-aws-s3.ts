...
export const O23ServerPluginAWSVariablePrefix = 'CFG_AWS_CLIENT_';
export const O23ServerPluginAWSVariableSuffixes: Array<EnvVariableDef> = [
	{
		name: 'ACCESS_KEY', category: EnvVariableCategory.O23_SERVER_PLUGIN_AWS,
		type: EnvVariableValueType.TEXT,
		description: 'AWS credential access key.'
	},
	{
		name: 'SECRET_KEY', category: EnvVariableCategory.O23_SERVER_PLUGIN_AWS,
		type: EnvVariableValueType.TEXT,
		description: 'AWS credential secret key.'
	},
	{
		name: 'SESSION_TOKEN', category: EnvVariableCategory.O23_SERVER_PLUGIN_AWS,
		type: EnvVariableValueType.TEXT,
		description: 'AWS credential session token.'
	},
	{
		name: 'CREDENTIAL_SCOPE', category: EnvVariableCategory.O23_SERVER_PLUGIN_AWS,
		type: EnvVariableValueType.TEXT,
		description: 'AWS credential scope.'
	},
	{
		name: 'REGION', category: EnvVariableCategory.O23_SERVER_PLUGIN_AWS,
		type: EnvVariableValueType.TEXT,
