...
export enum ProjectTreeNodeType {
	...
	MODULE_NON_ENV_COMMANDS = 'module-non-env-commands',
	MODULE_COMMAND = 'module-command',
	MODULE_ENVS = 'module-envs',
	MODULE_ENV = 'module-env',
	MODULE_ENV_COMMAND = 'module-env-command',
	MODULE_ENV_FILES = 'module-env-files',
	MODULE_ENV_FILES_DIR = 'module-env-files-dir',
	MODULE_ENV_FILES_FILE = 'module-env-files-file',
