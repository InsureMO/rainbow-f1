...
export const ProjectRoot = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="project-root" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
		<path
